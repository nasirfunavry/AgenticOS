...
const envSchema = z.object({
    ...
    CLIENT_ID: z.string().min(1, 'Twitter Client ID is required'),
    CLIENT_SECRET: z.string().min(1, 'Twitter Client Secret is required'),

    // Encryption Settings
    ENCRYPTION_KEY: z.string().min(32, 'Encryption key should be at least 32 characters long'),
